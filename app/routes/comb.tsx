  ...
  return (
    <div className='bg-black font-quicksand text-white'>
      ...
      <div className="flex flex-col items-center m-4 border-t-2">
        ...
        <div className="pb-4 w-3/4 text-center text-sm md:text-lg">I created two users to help me visualize how my application could solve some of their barriers or pain points when it comes to shellfish harvesting.</div>
        ...
        <div className="pb-4 w-3/4 text-center text-sm md:text-lg">Users want all of their shellfish harvesting information in one location. Users are required to check weather, tide information and red tide warnings all from different websites to plan their activity.</div>
      </div>
      ...
      <div className="flex flex-col items-center m-4">
        ...
        <div className="p-4 w-3/4 text-center text-sm md:text-lg">I did a quick ideation exercise to come up with ideas for how to address gaps identified in the competitive audit. My focus was specifically on the map feature and ensuring that additional features would not block its visibility or functionality.</div>
      </div>
      ...
      <div className="flex flex-col items-center m-4 pb-4">
        ...
        <div className="p-4 w-3/4 text-center m-4 text-sm md:text-lg">Based on insights from conducting usability studies, I applied a design colour scheme that is simplistic and modern. I ensured that the home screen has white space and does not become cluttered with elements.</div>
      ...
      <div className="flex flex-col items-center m-4 border-t-2">
        ...
        <div className="p-4 w-3/4 text-center text-sm md:text-lg">Now that the design was complete, it was time to pass it off to the web developers (also me hehe). I teamed up with Richard and we began converting my design to code! It was incredibly rewarding watching my design come to life! </div>
      ...
      <div className="flex flex-col items-center m-4 border-t-2">
        ...
        <div className="m-4 text-center">
          <div className="text-sm md:text-lg">The reason that I chose to earn a UI/UX Certificate after becoming a Full-Stack Developer was to experience the full process - from design - to implementation - and then deployment.</div>
          <br></br>
